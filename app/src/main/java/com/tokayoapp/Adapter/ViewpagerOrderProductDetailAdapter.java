...
public class ViewpagerOrderProductDetailAdapter extends PagerAdapter {
private Context context;
private LayoutInflater layoutInflater;
List<ProductDetailModal> productListModals;


    public ViewpagerOrderProductDetailAdapter(Context context, List<ProductDetailModal> productListModals) {
